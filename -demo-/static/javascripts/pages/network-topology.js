            ...
            data.push({
                ...
                tooltip: {
                    formatter: function(params, ticket, callback) {
                        ...
                        return 'Type：host<br/>' + 'IP：' + data.name + '<br/>' + 'MAC：' + data.mac + '<br/>' + 'switchID：' + data.sId + '<br/>' + 'switchPort：' + data.spId + '<br/>' + 'connectDuration：' + data.datetime
                    }
                },
                type: 'host',
            ...
            data.push({
                ...
                tooltip: {
                    formatter: function(params, ticket, callback) {
                        ...
                        return 'Type：switch<br/>' + 'IP：' + data.ip + '<br/>' + 'switchID：' + data.name + '<br/>' + 'openFlowVersion：' + data.openFlowVersion + '<br/>' + 'connectDuration：' + data.datetime
                    }
                },
                type: 'switch',
