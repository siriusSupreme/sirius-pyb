  ...
  methods: {
    ...
    setColumns () {
      this.columns = [
        ...
        {title: '接收对象', field: 'orgName', width: 80, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true},
        {title: '移送原因', field: 'reason', width: 120, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true},
